          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <div className={`w-3 h-3 rounded-full ${getRoleColor(session.user.userType)}`}></div>
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Here's what's happening with your telemedicine sessions today.
            </p>
          </div>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">Start a new group consultation</p>
                  </div>
                </div>
              </div>
            </Link>
              ...
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-sm text-gray-500">Enter an existing consultation</p>
                  </div>
                </div>
              </div>
            </Link>
